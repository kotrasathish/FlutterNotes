...
import 'package:mynotesflutter/utilitis/dialogs/password_reset_email_sent_dialog.dart';
      ...
      listener: (context, state) async{
        if(state is AuthStateForgotPassword){
          ...
          if(state.exception != null){
            showErrorDialog(context, 'We could not process your request. Please make sure that you are a registered user.');
          }
        }
      },
      child:Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text('If you forgot your password, please enter your email and we will send you a password reset link.'),
              TextField(
