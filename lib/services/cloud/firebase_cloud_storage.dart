...
import 'package:mynotesflutter/services/cloud/cloud_exceptions.dart';
import 'package:mynotesflutter/services/cloud/cloud_note.dart';
import 'package:mynotesflutter/services/cloud/cloud_storage_constants.dart';
  ...
  Future<Iterable<CloudNote>> getNotes({required String ownerUserId}) async {
    try{
      return await notes.where(
        ...
        final notes = value.docs.map((doc){
